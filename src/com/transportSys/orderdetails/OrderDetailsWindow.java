...
public class OrderDetailsWindow {
	...
	private void initialize() {
		 ...
		 * Edit Button
		 * 
		 * EditAction editButton = new EditAction("Edit", table, "orderNumber",
		 * "orderdetails"); editButton.setFont(new Font("Yu Gothic UI Semibold",
		 * Font.PLAIN, 12)); editButton.setText("EDIT");
		 * editButton.setMaximumSize(buttonSize); panelButtons.add(editButton);
		 */
